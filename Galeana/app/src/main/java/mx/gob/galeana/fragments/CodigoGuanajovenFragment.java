...
import mx.gob.galeana.api.IdGuanajovenAPI;
...
public class CodigoGuanajovenFragment extends CustomFragment {
    ...
    private static final String $CORREO_ENVIADO = "Se te ha enviado un correo electrónico con tu credencial, gracias por hacer de Galeana tu proyecto de vida.";
    ...
    public void onStart() {
        super.onStart();
        ((AppCompatActivity) getActivity()).getSupportActionBar().setTitle("ID Galeana");
    }
