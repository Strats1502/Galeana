...
import mx.gob.galeana.adapters.RVNotificacionAdapter;
import mx.gob.galeana.application.MyApplication;
import mx.gob.galeana.model.Notificacion;
import mx.gob.galeana.notifications.FirebaseMessagingService;
...
public class NotificacionesFragment extends CustomFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        intentFilter = new IntentFilter("mx.gob.galeana.NOTIFICACION_RECIBIDA");
    ...
    public void onResume() {
        ...
        imagen.setImageResource(R.drawable.backgroundgaleana3);
